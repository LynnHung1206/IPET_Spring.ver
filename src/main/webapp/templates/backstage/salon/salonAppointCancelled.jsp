...
<head>
  ...
  <title>IPET 寵物 | 美容專區 | 已取消的預約</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="${pageContext.request.contextPath}/ipet-back/appoint/appoints_cancelled">已取消的預約</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
